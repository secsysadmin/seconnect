...
class BudgetSubcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create budget_subcategory" do
    assert_difference('BudgetSubcategory.count') do
      post budget_subcategories_url, params: { budget_subcategory: { committee_id: @budget_subcategory.committee_id, subcategory_amount: @budget_subcategory.subcategory_amount, subcategory_name: @budget_subcategory.subcategory_name } }
    end
  ...
  test "should update budget_subcategory" do
    patch budget_subcategory_url(@budget_subcategory), params: { budget_subcategory: { committee_id: @budget_subcategory.committee_id, subcategory_amount: @budget_subcategory.subcategory_amount, subcategory_name: @budget_subcategory.subcategory_name } }
