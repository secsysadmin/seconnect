...
class CommitteesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create committee" do
    assert_difference('Committee.count') do
      post committees_url, params: { committee: { budget: @committee.budget, committee_name: @committee.committee_name, user_id: @committee.user_id } }
    end
  ...
  test "should update committee" do
    patch committee_url(@committee), params: { committee: { budget: @committee.budget, committee_name: @committee.committee_name, user_id: @committee.user_id } }
