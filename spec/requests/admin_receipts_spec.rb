  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new AdminReceipt" do
        ...
        }.to change(AdminReceipt, :count).by(1)
      end
    ...
    context "with invalid parameters" do
      it "does not create a new AdminReceipt" do
        ...
        }.to change(AdminReceipt, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested admin_receipt" do
        admin_receipt = AdminReceipt.create! valid_attributes
        patch admin_receipt_url(admin_receipt), params: { admin_receipt: new_attributes }
    ...
    context "with invalid parameters" do
      it "renders a successful response (i.e. to display the 'edit' template)" do
        admin_receipt = AdminReceipt.create! valid_attributes
        patch admin_receipt_url(admin_receipt), params: { admin_receipt: invalid_attributes }
        expect(response).to be_successful
      end
    end
  end
