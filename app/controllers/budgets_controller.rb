...
class BudgetsController < ApplicationController
     ...
     # GET /budgets/:id/categories.json
     def categories
       @budget = Budget.find(params[:id])
       categories = @budget.budget_categories.includes(:budget_subcategories)
   
       render json: categories.as_json(include: :budget_subcategories)
     end
